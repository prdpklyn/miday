...
class Habit extends DataClass implements Insertable<Habit> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, icon, frequency, streakCount, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Habit &&
...
final class $$EventsTableReferences
  ...
  static MultiTypedResultKey<$TasksTable, List<Task>> _tasksRefsTable(
    ...
    db.tasks,
    aliasName: $_aliasNameGenerator(db.events.id, db.tasks.linkedEventId),
  );
  ...
  static MultiTypedResultKey<$NotesTable, List<Note>> _notesRefsTable(
    ...
    db.notes,
    aliasName: $_aliasNameGenerator(db.events.id, db.notes.linkedEventId),
  );
...
class $$EventsTableTableManager
    extends
        RootTableManager<
          ...
          Event,
          PrefetchHooks Function({bool tasksRefs, bool notesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({tasksRefs = false, notesRefs = false}) {
                ...
                return [
                  if (tasksRefs)
                    await $_getPrefetchedData<Event, $EventsTable, Task>(
                      currentTable: table,
                      referencedTable: $$EventsTableReferences._tasksRefsTable(
                        db,
                      ),
                  ...
                  if (notesRefs)
                    await $_getPrefetchedData<Event, $EventsTable, Note>(
                      currentTable: table,
                      referencedTable: $$EventsTableReferences._notesRefsTable(
                        db,
                      ),
                      managerFromTypedResult: (p0) =>
...
final class $$TasksTableReferences
  ...
  static $EventsTable _linkedEventIdTable(_$AppDatabase db) => db.events
      .createAlias($_aliasNameGenerator(db.tasks.linkedEventId, db.events.id));
  ...
  static MultiTypedResultKey<$NotesTable, List<Note>> _notesRefsTable(
    ...
    db.notes,
    aliasName: $_aliasNameGenerator(db.tasks.id, db.notes.linkedTaskId),
  );
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          Task,
          PrefetchHooks Function({bool linkedEventId, bool notesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({linkedEventId = false, notesRefs = false}) {
            return PrefetchHooks(
              db: db,
                ...
                return [
                  if (notesRefs)
                    await $_getPrefetchedData<Task, $TasksTable, Note>(
                      currentTable: table,
                      referencedTable: $$TasksTableReferences._notesRefsTable(
                        db,
                      ),
                      managerFromTypedResult: (p0) =>
...
final class $$NotesTableReferences
  ...
  static $EventsTable _linkedEventIdTable(_$AppDatabase db) => db.events
      .createAlias($_aliasNameGenerator(db.notes.linkedEventId, db.events.id));
  ...
  static $TasksTable _linkedTaskIdTable(_$AppDatabase db) => db.tasks
      .createAlias($_aliasNameGenerator(db.notes.linkedTaskId, db.tasks.id));
...
class $$NotesTableTableManager
    extends
        RootTableManager<
          ...
          Note,
          PrefetchHooks Function({bool linkedEventId, bool linkedTaskId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({linkedEventId = false, linkedTaskId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
